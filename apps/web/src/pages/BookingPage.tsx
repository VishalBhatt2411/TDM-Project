...
import { createPublicBooking, isBookingConflictError } from "@/api/bookings";
    ...
    <div className="mx-auto max-w-2xl px-4 py-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Fill in your details — no account needed to get started.</CardDescription>
        </CardHeader>
        <CardContent>
